...
<!-- Mirrored from htmldemo.net/zymzoo/zymzoo/shop-single-product-right-sidebar.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 08:47:41 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Product Details - Zymzoo - Gym & Fitness Centre Bootstrap 5 Template</title>
            ...
            <div class="row row-gutter-0">
              ...
              <div class="col-md-6">
                <div class="single-product-info">
                  <h4 class="title">HAND DUMBLE</h4>
                  <div class="product-availability">
                    <span>$2.5 per kg</span>
                  </div>
                  <p class="product-desc">Hand Dumble is very professional and expert trainer. In his job. He never compromise about his work to maintain our sed cuuntur magni dolores eos qui rat ione volupta</p>
                  <div class="single-product-desc">
                    <div class="product-stock">
                      <h5 class="title">Stock: <span>Available</span></h5>
                    </div>
                    <div class="product-sku">
                      <h5 class="title">SKU:<span>35487kbckl</span></h5>
                    </div>
                    ...
                    <div class="product-category">
                      <h5 class="title">Category:<span>Fitness</span></h5>
                    </div>
              ...
              <div class="col-lg-12">
                <div class="product-description-review">
                  <ul class="nav nav-tabs product-description-tab-menu" id="myTab" role="tablist">
                    ...
                    <li class="nav-item" role="presentation">
                      <button class="nav-link" id="product-aditional-tab" data-bs-toggle="tab" data-bs-target="#commentProduct" type="button" role="tab" aria-selected="false">Aditional Info</button>
                    </li>
                    <li class="nav-item" role="presentation">
                    ...
                    <div class="tab-pane fade" id="commentProduct" role="tabpanel" aria-labelledby="product-aditional-tab">
                      <div class="product-aditional-info product-shipping-policy">
                        <div class="section-title">
                          <h2 class="title">Aditional Info</h2>
                  ...
                  <div class="row">
                    <div class="col-sm-4">
                      ...
                      <div class="product-item mb-xs-30">
                        ...
                        <div class="product-info">
                          <h4 class="title"><a href="shop-single.html">Workout Tank Top</a></h4>
                          <div class="prices">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="product-item mb-xs-30">
                        ...
                        <div class="product-info">
                          <h4 class="title"><a href="shop-single.html">Ab Roller</a></h4>
                          <div class="prices">
                    ...
                    <div class="col-sm-4">
                      ...
                      <div class="product-item">
                        ...
                        <div class="product-info">
                          <h4 class="title"><a href="shop-single.html">Skipping Rope</a></h4>
                          <div class="prices">
            ...
            <div class="sidebar-area shop-sidebar-area mt-md-90">
              ...
              <div class="widget-item">
                ...
                <div class="widget-body widget-categorie-body">
                  <div class="widget-categories">
                    <ul>
                      <li><a href="blog.html">Fitness Ball <span>25</span></a></li>
                      <li><a href="blog.html">Gym Bag<span>52</span></a></li>
                      <li><a href="blog.html">Water Bottle<span>12</span></a></li>
                      <li><a href="blog.html">Workout Tank Top<span>18</span></a></li>
                      <li><a href="blog.html">Skipping Rope<span>45</span></a></li>
                      <li><a href="blog.html">Ab Roller<span>72</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="widget-item">
                <div class="widget-content-ads">
                  <div class="ads-thumb">
                    <a href="shop-single.html"><img src="assets/img/shop/s1.jpg" alt="Image"></a>
                  </div>
                </div>
              </div>
            </div>
