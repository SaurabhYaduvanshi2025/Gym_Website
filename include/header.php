              ...
              <ul class="main-menu nav position-relative">
                ...
                <!-- <li class="has-submenu"><a href="shop.php">Shop</a>
                  <ul class="submenu-nav">
                    ...
                    <li><a href="shop-single-product.php">Product Details</a></li>
                    <li><a href="shop-single-product-left-sidebar.php">Product Details Left Sidebar</a></li>
                ...
                <li class="has-submenu"><a href="team.php">Trainers</a>
                  <ul class="submenu-nav">
                    ...
                    <li><a href="team-details.php">Trainer Details</a></li>
                  </ul>
                </li>
