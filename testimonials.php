...
<head>
    ...
    <title>Testimonials - Zymzoo - Gym & Fitness Centre Bootstrap 5 Template</title>
...
<!--wrapper start-->
<div class="wrapper testimonials-default-wrapper">
        ...
        <div class="row">
          <div class="col-lg-12">
            <div class="page-title-content content-style2">
              ...
              <div class="desc">
                <p class="ml-0">What our clients say about us is important,<br>see what they have to share about their experience</p>
              </div>
            </div>
          </div>
        </div>
