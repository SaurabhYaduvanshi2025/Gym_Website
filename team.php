...
<!-- Mirrored from htmldemo.net/zymzoo/zymzoo/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 08:47:41 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Team - Zymzoo - Gym & Fitness Centre Bootstrap 5 Template</title>
...
<!--wrapper start-->
<div class="wrapper page-team-wrapper">
  ...
  <main class="main-content">
        ...
        <div class="row">
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="team-item">
              <div class="team-member">
                <div class="thumb">
                  <a href="team-details.html"><img src="assets/img/team/5.jpg" alt="Image"></a>
                </div>
                <div class="content">
                  <div class="member-info">
                    <h4 class="name"><a href="team-details.html">Alvin Santiago</a></h4>
                    <h6 class="designation">Aerobics Trainer</h6>
                    <div class="social-icons">
                      <a href="#/"><i class="fa fa-facebook icon"></i></a>
                      <a href="#/"><i class="fa fa-phone icon"></i></a>
                      <a href="#/"><i class="fa fa-instagram icon"></i></a>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="team-item">
              <div class="team-member">
                <div class="thumb">
                  <a href="team-details.html"><img src="assets/img/team/6.jpg" alt="Image"></a>
                </div>
                <div class="content">
                  <div class="member-info">
                    <h4 class="name"><a href="team-details.html">Halbert Bourn</a></h4>
                    <h6 class="designation">Cardio Trainer</h6>
                    <div class="social-icons">
                      <a href="#/"><i class="fa fa-facebook icon"></i></a>
                      <a href="#/"><i class="fa fa-phone icon"></i></a>
                      <a href="#/"><i class="fa fa-instagram icon"></i></a>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="team-item">
              <div class="team-member">
                <div class="thumb">
                  <a href="team-details.html"><img src="assets/img/team/7.jpg" alt="Image"></a>
                </div>
                <div class="content">
                  <div class="member-info">
                    <h4 class="name"><a href="team-details.html">Shirley Atkinson</a></h4>
                    <h6 class="designation">Yoga Trainer</h6>
                    <div class="social-icons">
                      <a href="#/"><i class="fa fa-facebook icon"></i></a>
                      <a href="#/"><i class="fa fa-phone icon"></i></a>
                      <a href="#/"><i class="fa fa-instagram icon"></i></a>
          ...
          <div class="col-sm-6 col-md-4 col-lg-3">
            ...
            <div class="team-item">
              <div class="team-member">
                <div class="thumb">
                  <a href="team-details.html"><img src="assets/img/team/8.jpg" alt="Image"></a>
                </div>
                <div class="content">
                  <div class="member-info">
                    <h4 class="name"><a href="team-details.html">Alex Bradley</a></h4>
                    <h6 class="designation">Bodybuilding Trainer</h6>
                    <div class="social-icons">
                      <a href="#/"><i class="fa fa-facebook icon"></i></a>
                      <a href="#/"><i class="fa fa-phone icon"></i></a>
    ...
    <section class="testimonial-area testimonial-inner-area">
      <div class="container">
        <div class="row">
          <div class="col-lg-6">
...
<!-- Mirrored from htmldemo.net/zymzoo/zymzoo/team.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 08:47:43 GMT -->
</html>