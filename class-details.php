...
<!-- Mirrored from htmldemo.net/zymzoo/zymzoo/class-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 08:47:23 GMT -->
<head>
    <meta charset="utf-8">
    <meta http-equiv="X-UA-Compatible" content="IE=edge">
    <meta name="viewport" content="width=device-width, initial-scale=1.0" />

    <title>Class Details - Zymzoo - Gym & Fitness Centre Bootstrap 5 Template</title>
...
<!--wrapper start-->
<div class="wrapper class-details-wrapper">
              ...
              <div class="row row-gutter-22 team-items-style2">
                <div class="col-sm-6">
                  ...
                  <div class="team-item mb-xs-30">
                    <div class="team-member">
                      <div class="thumb">
                        <a href="team-details.html"><img src="assets/img/team/10.jpg" alt="Image"></a>
                      </div>
                      <div class="content">
                ...
                <div class="col-sm-6">
                  ...
                  <div class="team-item">
                    <div class="team-member">
                      <div class="thumb">
                        <a href="team-details.html"><img src="assets/img/team/9.jpg" alt="Image"></a>
                      </div>
                      <div class="content">
                        <div class="member-info">
                          <h4 class="name"><a href="team-details.html">Robert Cristoper</a></h4>
                          <h6 class="designation">Bodybuild Trainer</h6>
                          <div class="social-icons">
                            <a href="#"><i class="fa fa-facebook icon"></i></a>
                            <a href="#"><i class="fa fa-phone icon"></i></a>
            ...
            <div class="sidebar-area class-sidebar-area inner-right-padding mt-md-90">
              <div class="widget-item">
                ...
                <div class="widget-body widget-categorie-body">
                  <div class="widget-categories2">
                    <ul>
                      <li><a href="class-details.html">Fitness Class <span>View</span></a></li>
                      <li><a href="class-details.html">Crossfit Class<span>View</span></a></li>
                      <li class="active"><a href="class-details.html">Body Building Class<span>Viewed</span></a></li>
                      <li class="yoga"><a href="class-details.html">Yoga Class<span>View</span></a></li>
                      <li><a href="class-details.html">Martial Art Class<span>View</span></a></li>
                      <li><a href="class-details.html">Cardio Class<span>View</span></a></li>
                    </ul>
                  </div>
                </div>
              </div>
              ...
              <div class="widget-item">
                <div class="widget-content-ads">
                  <div class="ads-thumb">
                    <a href="class-details.html"><img src="assets/img/blog/a01.png" alt="Image"></a>
                  </div>
                </div>
              </div>
              <div class="widget-item">
                ...
                <div class="widget-body widget-download-body p-0">
                  <div class="widget-download">
                    <ul>
                      <li><a href="#/"><i class="fa fa-file-pdf-o"></i>Brochure PDF version</a></li>
                      <li><a href="#/"><i class="fa fa-file-word-o"></i>Brochure Word version</a></li>
                      <li><a href="#/"><i class="fa fa-file-powerpoint-o"></i>Power Point Presentation</a></li>
                    </ul>
                  </div>
                </div>
              </div>
...
<!-- Mirrored from htmldemo.net/zymzoo/zymzoo/class-details.html by HTTrack Website Copier/3.x [XR&CO'2014], Sat, 06 Jun 2026 08:47:35 GMT -->
</html>